...
*            2022.05.05 - Testpattern deactivated to switch through display screens
*/
...
void loop() {
  ...
  display.display();
  delay(2000);
  // noInterrupts(); fillx(0);                // Test call. Disable for debugging

  interrupts();
  Serial.println();
  Serial.print("Test pattern 10");
  // OLED Display output
  display.clearDisplay();
  display.setTextSize(1);                     // Normal 1:1 pixel scale
  display.setTextColor(SSD1306_WHITE);        // Draw white text
  ...
  display.display();
  delay(2000);
  // noInterrupts(); fillx(1);                   // Test call. Disable for debugging

  interrupts();
  Serial.println();
  Serial.print("Test with all 0");
  // OLED Display output
  display.clearDisplay();
  display.setTextSize(1);                     // Normal 1:1 pixel scale
  display.setTextColor(SSD1306_WHITE);        // Draw white text
  ...
  display.display();
  delay(2000);
  // noInterrupts(); fill(0);                    // Test call. Disable for debugging
  ...
  display.display();
  delay(2000);
  // noInterrupts(); fill(1);                    // Test call. Disable for debugging
  ok();
}
